...
const getAll = async (req, res) => {
    ...
    try {
    const result = await mongodb.getDatabase().db().collection('smissions').find();
...
const getSingle = async (req, res) => {
    ...
    try {
        ...
        const result = await mongodb.getDatabase().db().collection('smissions').find({ _id: missionId });
        result.toArray().then((missions) => {
            res.setHeader('Content-Type', 'application/json');
...
const createMission = async (req, res) => {
    ...
    try {
        ...
        const response = await mongodb.getDatabase().db().collection('smissions').insertOne(mission);
...
const updateMission = async (req, res) => {
    ...
    try {
        ...
        const response = await mongodb.getDatabase().db().collection('smissions').replaceOne({ _id: missionId }, mission);
...
const deleteMission = async (req, res) => {
    ...
    try {
        ...
        const missionId = new ObjectId(req.params.id);
        const response = await mongodb.getDatabase().db().collection('smissions').deleteOne({ _id: missionId });
